...
function Navbar({ logo }) {
    ...
    useEffect(() => {
        !displaySearch&&searchRef.current.focus()
        !displaySearch&&(document.addEventListener("mousedown",e=>{
            !e.target.className.includes('search')&&setDisplaySearch(true)
        }))
    }, [displaySearch])
  return (
    <div className="header-navbar">
      ...
      <div className="navbar-search" onClick={()=>setDisplaySearch(false)}>
          <input 
            ref={searchRef}
            ...
            type="text"
            />
            {!displaySearch&&(<div className="navbar-search-suggestions">
                <div className="navbar-search-recent">Recent</div>
                <div className="navbar-search-recent--noRecent">No recent searches</div>
            </div>)}
          <div className="navbar-search-clear-icon" >
            <i className="fas fa-times-circle search-clear" onClick={(e)=>{
              e.stopPropagation()
              setDisplaySearch(true)}}/>
          </div>
          {displaySearch&&<div className="navbar-searchbar--show">
